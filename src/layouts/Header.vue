...
<!--header class="mx-auto w-full lg:w-3/4">
  ...
  <header class="sticky top-0 z-40 flex justify-between items-center p-5 bg-base-200 border-b-1 border-gray-700">
    <div class="flex items-center">
      ...
      <div v-if="true" class="flex items-center space-x-5 ml-3">
